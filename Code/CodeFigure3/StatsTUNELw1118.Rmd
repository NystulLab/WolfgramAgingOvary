...
##Stats for TUNEL on Fas3 border in 1 weeks, no phenotype vs phenotype
...
write.csv(
  glmm_tunel,
  "Results/ResultsFigure3/StatsTUNELFas31wkNovsPhenoGlmm.csv",
  row.names = FALSE
)
```
...
```{r}
df1 <- read_csv("Results/ResultsFigure3/StatsTUNELFas31wkNovsPhenoGlmm.csv")
df2 <- read_csv("Results/ResultsFigure3/StatsTUNELFas36wkNovsPhenoGlmm.csv")

merged_df <- rbind(df1,df2)

write.csv(
  merged_df,
  "Results/ResultsFigure3/StatsTUNELFas3byPhenoGlmm.csv",
  row.names = FALSE
)
```

##Stats for Phenotype penetrance for 1 vs 6 weeks in No TUNEL Band Condition 
...
ttest_tunel1v6avg_df <- data.frame(
  comparison = "6 Weeks",
  p_value = p_val,
  stars = stars
)

print(ttest_tunel1v6avg_df)
```

```{r}
write.csv(
  ttest_tunel1v6avg_df,
  "Results/ResultsFigure3/StatsPhenoNoTUNEL1v6ttest.csv",
  row.names = FALSE
)
```